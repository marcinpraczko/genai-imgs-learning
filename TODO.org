...
** TODO [/] [%] Goal-01 - Page migrated from org-mode to Sphinx+ABLOG

*** TODO 001 - [/] Create initial sphinx+ablog config
:PROPERTIES:
:ID:       001
:END:

*** TODO 002 - [/] Add first post with images - migrate from ORG
:PROPERTIES:
:ID:       002
:END:

*** TODO 003 - [/] Add others post - migrate from ORG
:PROPERTIES:
:ID:       003
:END:
...
*** TODO 007 - [/] Add scripts for creating python venv
:PROPERTIES:
:ID:       007
:END:

- [ ] For now project will have manual venv creation
